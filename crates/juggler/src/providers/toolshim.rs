...
/// - JUGGLER_TOOLSHIM: When set to "true" or "1", enables using the tool shim in the standard OllamaProvider (default: false)
/// - JUGGLER_TOOLSHIM_OLLAMA_MODEL: Ollama model to use as the tool interpreter (default: DEFAULT_INTERPRETER_MODEL)
...
";
        ...
        let interpreter_model = std::env::var("JUGGLER_TOOLSHIM_OLLAMA_MODEL")
