...
/// Represents available GCP Vertex AI models for Juggler.
///
...
/// Represents available versions of the Claude model for Juggler.
#[derive(Debug, Clone, PartialEq, Eq)]
...
/// Represents available versions of the Gemini model for Juggler.
#[derive(Debug, Clone, PartialEq, Eq)]
