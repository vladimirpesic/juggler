...
use juggler::scheduler::ScheduledJob;
...
async fn create_schedule(
    ...
    scheduler
        ...
        .map_err(|e| {
            ...
            match e {
                juggler::scheduler::SchedulerError::JobNotFound(_) => StatusCode::NOT_FOUND,
                juggler::scheduler::SchedulerError::CronParseError(_) => StatusCode::BAD_REQUEST,
                juggler::scheduler::SchedulerError::RecipeLoadError(_) => StatusCode::BAD_REQUEST,
                juggler::scheduler::SchedulerError::JobIdExists(_) => StatusCode::CONFLICT,
...
async fn run_now_handler(
    ...
    match scheduler.run_now(&id).await {
        ...
        Err(e) => {
            ...
            match e {
                juggler::scheduler::SchedulerError::JobNotFound(_) => Err(StatusCode::NOT_FOUND),
                juggler::scheduler::SchedulerError::AnyhowError(ref err) => {
...
async fn sessions_handler(
    ...
    {
        Ok(session_tuples) => {
            // Expecting Vec<(String, juggler::session::storage::SessionMetadata)>
...
async fn pause_schedule(
    ...
    scheduler.pause_schedule(&id).await.map_err(|e| {
        ...
        match e {
            juggler::scheduler::SchedulerError::JobNotFound(_) => StatusCode::NOT_FOUND,
            juggler::scheduler::SchedulerError::AnyhowError(_) => StatusCode::BAD_REQUEST,
            _ => StatusCode::INTERNAL_SERVER_ERROR,
        }
    })?;
    Ok(StatusCode::NO_CONTENT)
