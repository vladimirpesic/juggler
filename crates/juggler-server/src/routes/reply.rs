...
mod tests {
    ...
    impl Provider for MockProvider {
        fn metadata() -> juggler::providers::base::ProviderMetadata {
            juggler::providers::base::ProviderMetadata::empty()
        }
    ...
    mod integration_tests {
        ...
        async fn test_ask_endpoint() {
            ...
            let scheduler_path = juggler::scheduler::get_default_scheduler_storage_path()
                .expect("Failed to get default scheduler storage path");
            let scheduler =
                juggler::scheduler_factory::SchedulerFactory::create_legacy(scheduler_path)
                    .await
                    .unwrap();
