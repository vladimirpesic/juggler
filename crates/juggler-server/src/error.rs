...
mod tests {
    ...
    fn test_env_var_conversion() {
        assert_eq!(to_env_var("type"), "JUGGLER_PROVIDER__TYPE");
        assert_eq!(to_env_var("api_key"), "JUGGLER_PROVIDER__API_KEY");
        assert_eq!(to_env_var("provider.host"), "JUGGLER_PROVIDER__HOST");
        assert_eq!(to_env_var("provider.api_key"), "JUGGLER_PROVIDER__API_KEY");
    }
}
