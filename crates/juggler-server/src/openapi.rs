use juggler::agents::extension::Envs;
use juggler::agents::extension::ToolInfo;
use juggler::agents::ExtensionConfig;
use juggler::config::permission::PermissionLevel;
use juggler::config::ExtensionEntry;
use juggler::message::{
...
use juggler::providers::base::{ConfigKey, ModelInfo, ProviderMetadata};
use juggler::session::info::SessionInfo;
use juggler::session::SessionMetadata;
...
#[openapi(
    ...
    components(schemas(
        ...
        juggler::scheduler::ScheduledJob,
