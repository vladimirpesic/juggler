...
impl ComputerControllerRouter {
    pub fn new() -> Self {
        ...
        // - macOS/Linux: ~/.cache/juggler/computer_controller/
        // - Windows:     ~\AppData\Local\juggler\cache\computer_controller\
        ...
        Self {
            ...
            http_client: Client::builder().user_agent("Juggler/1.0").build().unwrap(),
