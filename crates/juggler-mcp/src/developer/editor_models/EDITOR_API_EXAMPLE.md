...
```bash
export JUGGLER_EDITOR_API_KEY="your-api-key-here"
export JUGGLER_EDITOR_HOST="https://api.openai.com/v1"
export JUGGLER_EDITOR_MODEL="gpt-4o"
```
...
**OpenAI:**
```bash
export JUGGLER_EDITOR_API_KEY="sk-..."
export JUGGLER_EDITOR_HOST="https://api.openai.com/v1"
export JUGGLER_EDITOR_MODEL="gpt-4o"
```
...
```bash
export JUGGLER_EDITOR_API_KEY="sk-ant-..."
export JUGGLER_EDITOR_HOST="https://api.anthropic.com/v1"
export JUGGLER_EDITOR_MODEL="claude-3-5-sonnet-20241022"
```

**Morph:**
```bash
export JUGGLER_EDITOR_API_KEY="sk-..."
export JUGGLER_EDITOR_HOST="https://api.morphllm.com/v1"
export JUGGLER_EDITOR_MODEL="morph-v0"
```

**Relace**
```bash
export JUGGLER_EDITOR_API_KEY="rlc-..."
export JUGGLER_EDITOR_HOST="https://instantapply.endpoint.relace.run/v1/apply"
export JUGGLER_EDITOR_MODEL="auto"
```

**Local/Custom endpoints:**
```bash
export JUGGLER_EDITOR_API_KEY="your-key"
export JUGGLER_EDITOR_HOST="http://localhost:8000/v1"
export JUGGLER_EDITOR_MODEL="your-model"
```
